...
if (!defined('Fayen_PAGE_TITLE')) { define('Fayen_PAGE_TITLE', $pageTitle); }
...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top flex-md-nowrap p-0 shadow" style="background-color: #225470;">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="../index.php">Fayen</a>
 </nav>
